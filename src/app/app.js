    ...
    return {
      projects: [
        new Project(
          'new-hope',
          'Esperanto Tokenizer',
          'http://www.maroun-baydoun.com/projects/new-hope/',
        ...
        new Project(
          ...
          'http://www.maroun-baydoun.com/projects/mediaq/',
        ...
        new Project(
          ...
          'http://dev.maroun-baydoun.com/evented/',
          'https://github.com/maroun-baydoun/evented',
          ['TypeScript', 'Webpack']
        ),
      ],
    };
