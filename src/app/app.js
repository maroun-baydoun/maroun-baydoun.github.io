  ...
  data: function() {
    return {
      projects: [
        ...
        new Project('Mediaq', 'Listen to media query updates in JavaScript', 'http://www.maroun-baydoun.com/projects/mediaq/', 'https://github.com/maroun-baydoun/mediaq', ['TypeScript', 'Webpack']),
